...
unnecessary for resumed chains. Adding the command \texttt{-nosdmcmc} can also save computation time, but the original chain must have been run with \texttt{-nosdmcmc}. Otherwise, ADMB will try to read non-existent histogram data (found in the \texttt{.hst} file).
