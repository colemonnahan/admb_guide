...
\hlstd{write.admb.cov} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{cov.user}\hlstd{,} \hlkwc{model.path} \hlstd{=} \hlkwd{getwd}\hlstd{()) \{}
    ...
    \hlkwa{if} \hlstd{(}\hlopt{!}\hlstd{temp)}
        \hlkwd{stop}\hlstd{(}\hlkwd{paste0}\hlstd{(}\hlstr{"Couldn't find file "}\hlstd{, model.path,} \hlstr{"/admodel.cov"}\hlstd{))}
    \hlstd{temp} \hlkwb{<-} \hlkwd{file.copy}\hlstd{(}\hlkwc{from} \hlstd{=} \hlkwd{paste0}\hlstd{(model.path,} \hlstr{"/admodel.cov"}\hlstd{),} \hlkwc{to} \hlstd{=} \hlkwd{paste0}\hlstd{(model.path,}
        \hlstr{"/admodel_original.cov"}\hlstd{))}
